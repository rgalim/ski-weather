...
class SkiAreaWeatherServiceTest {
    ...
    fun `should convert weather forecast to ski area weather when forecast has correct format`() {
        ...
        val skiAreaWeather = skiAreaWeatherService.convertToSkiAreaWeather(weatherForecast)
    ...
    fun `should throw exception when daily forecast is empty`() {
        ...
        val exception = assertThrows<IllegalArgumentException> { skiAreaWeatherService.convertToSkiAreaWeather(weatherForecast) }
